...
이 저장소는 **[로또아이(LOTTOi)](https://www.lottoi.kr)** 서비스의  
**결과 공개 검증 구조**를 구성하는  
...
[로또아이](https://www.lottoi.kr)는 각 회차마다 회원이 생성한 번호를  
...
이는 [로또아이](https://www.lottoi.kr) 서비스 전반에서 사용하는  
**공개 검증 구조의 일부**입니다.
...
[로또아이](https://www.lottoi.kr) 서비스 전체의 공개 검증 원칙,  
